...
| **5. Start Demo Walkthrough** | "To make running the demo frictionless, we have an interactive 5-step demo walkthrough that guides us on choosing agents and sending queries." | Demo walkthrough panel pointing to the next actions. |
